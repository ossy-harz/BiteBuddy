...
/// iOS-inspired design system for BiteBuddy app
class IOSTheme {
  ...
  static const Color neutralLight = Color(0xFFF2F2F7);  // iOS Light Background
  static const Color neutralDark = Color(0xFF1C1C1E);   // iOS Dark Background

  // Secondary Colors
  static const Color secondaryLight = Color(0xFF5AC8FA); // iOS Light Blue
  static const Color secondaryDark = Color(0xFF64D2FF);  // iOS Light Blue (Dark Mode)

  // Accent Colors
  static const Color accentLight = Color(0xFFFF9500);   // iOS Orange
  static const Color accentDark = Color(0xFFFF9F0A);    // iOS Orange (Dark Mode)
  ...
  static const Color surfaceDark = Color(0xFF2C2C2E);   // iOS Dark Gray
  ...
  // Food Category Colors - iOS inspired
  static const Color fruitsColor = Color(0xFFFF2D55);     // iOS Pink
  static const Color vegetablesColor = Color(0xFF34C759); // iOS Green
  static const Color dairyColor = Color(0xFF5AC8FA);      // iOS Light Blue
  static const Color meatColor = Color(0xFFAF52DE);       // iOS Purple
  static const Color grainsColor = Color(0xFFFF9500);     // iOS Orange
  static const Color spicesColor = Color(0xFFFF2D55);     // iOS Pink
  ...
  // Border Radius - iOS style uses more rounded corners
  ...
  static ThemeData darkTheme() {
    ...
    return ThemeData(
      ...
      dividerTheme: const DividerThemeData(
        color: Color(0xFF38383A), // iOS dark mode divider color
        thickness: 1,
        space: spacingMd,
      ),
      bottomSheetTheme: const BottomSheetThemeData(
